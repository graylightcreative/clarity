<main class="flex-grow max-w-7xl mx-auto px-6 py-20 w-full">
    <div class="mb-16">
        ...
        <p class="text-white/60 text-lg font-light max-w-2xl">The complete operational manual for NGN Clarity: The Mixing Mentor.</p>
    </div>
        ...
        <aside class="md:col-span-1">
            <div class="sticky top-32 space-y-12">
                <div class="space-y-4">
                    ...
                    <div class="space-y-4 text-[10px] uppercase tracking-[0.2em] text-white/40 font-bold">
                        ...
                        <a href="#sovereign-link" class="block hover:text-ngn-orange transition-colors text-white/80">03 // Sovereign Link</a>
